<?php
$password = "changeMe";
$allowedServices = [["hhvm", ["start", "stop", "restart", "reload"]], ["php5-fpm", ["restart", "reload"]], ["nginx", []], ["sshd", []], ["proftpd", []]];
...
if (isset($_POST['password'])) {
    ...
    //
    //WARNING!
    //APPLYING THE LINE YOU ALLOW THE www-data USER TO EXECUTE SCRIPTS AS ROOT!
    //BE SURE THAT YOUR OTHER SITES DO NOT INCLUDE ANY VULNERABILITY THAT COULD PERMIT A USER TO DO A REMOTE EXECUTION EXPLOIT
